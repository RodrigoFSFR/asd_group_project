...
def profileWindow():
    ...
    userLogo = tk.PhotoImage(file="user.png")
    ...
    ButtonExit = tk.Button(profileWindow, text="Back", width=10, command=Back, font=("Sans-serif", 16))
...
ButtonTakeOrders.grid(row=2, column=1, sticky="E")
ButtonPayment.grid(row=3, column=1, sticky="E")
